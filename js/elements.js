...
export const modalProductTitle = modalProduct.querySelector(
  '.modal-product__title',
);
export const modalProductImage = modalProduct.querySelector(
  '.modal-product__image',
);
export const modalProductDescription = modalProduct.querySelector(
  '.modal-product__description',
);
export const ingredientsList = modalProduct.querySelector('.ingredients__list');
export const ingredientsCalories = modalProduct.querySelector(
  '.ingredients__calories',
);
export const modalProductPriceCount = modalProduct.querySelector(
